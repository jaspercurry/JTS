...
| [docs/doc-map.toml](docs/doc-map.toml) | Maintainers / AI agents | Documentation routing: code globs → canonical docs to scan, safety class, and suggested verification. Advisory, looked up with `scripts/docs-impact.py --changed-file <path>`; CI only validates the map. |
