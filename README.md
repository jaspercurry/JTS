...
| `jasper-wifi-recover` (Wi-Fi-down periodic nudge) | Active timer | ~0 resident; one-shot only | healthy tick is one NM read every 90 s; repair path only when Wi-Fi is down |
