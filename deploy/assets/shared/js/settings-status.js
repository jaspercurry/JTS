...
export function initSettingsStatus({ caps, titleFollowsSpeakerName } = {}) {
  ...
  // A surface with no live sublabel has nothing to poll for, and
  // /system/data.json is a socket-activated wizard that an open tab would
  // otherwise hold awake for no visible change.
