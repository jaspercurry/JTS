// dom.js — tiny hyperscript helper, zero dependencies.
//
...
//
// Text children become text nodes, so untrusted values (HA URLs, AirPlay
// event detail, Camilla config paths, service names) are escaped by the
// DOM — there is no innerHTML path to forget to sanitise.
