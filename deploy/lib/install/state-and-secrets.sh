...
# env files jasper-control reads, and render the voice-provider id manifest.
# All are idempotent and safe on fresh installs. The one-shot migrations that
# used to live here are in retirements.sh.
