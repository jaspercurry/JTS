...
Read [`docs/web-ia.md`](../../../docs/web-ia.md) (navigation, page shell,
submit model, the single-owner reuse table) and
[`docs/design-language.md`](../../../docs/design-language.md) (the craft layer)
before editing.
