...
**Audit fixes landed:** [#4677](https://github.com/jaspercurry/JTS/pull/4677)
...
| 3.2b | **LANDED — #4680; satisfies the adapter-policy gate for 3.3.** Generated sealed, ported and PR filters obey the selected boost cap. Sealed subsonic ratio/order now use the existing margin policy. Rebuild affected families before the bench campaign; digital headroom remains distinct from driver protection proof. | C | Independent emitted-coefficient tests across the admitted sealed fit domain and all margins; subsonic values survive emission. | **NN** |
