...
use jasper_daemon::json::{
    event_age_ms, json_string, push_kv_bool, push_kv_f64, push_kv_f64_opt, push_kv_str,
    push_kv_str_opt, push_kv_u64, push_kv_u64_opt, NEVER_MS,
};
...
impl OutputdState {
    ...
    fn snapshot_json_at(&self, uptime_ms: u64) -> String {
        ...
        let dac_delay_frames = self.dac_json(&mut buf, sample_rate, uptime_ms, dac_xrun_count);
        self.dual_apple_json(&mut buf);
