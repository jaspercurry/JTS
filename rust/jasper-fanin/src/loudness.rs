//! Streaming assistant/content loudness policy for pre-DSP TTS.
//!
//! This mirrors `jasper-outputd`'s assistant loudness matcher so the
//! active-speaker fan-in path can route TTS through CamillaDSP
//! crossover/protection without losing the final-output safety policy.
