...
REASON_REGISTRY: dict[str, ReasonSpec] = {
    "bass_fit_common_coverage_unavailable": ReasonSpec(
        ...
        next_action={"id": "measure_bass_coverage", "label": "Measure both graphs over the target band"},
    ),
    "bass_fit_capture_context_changed": ReasonSpec(
        ...
        next_action={"id": "match_bass_capture", "label": "Measure both graphs at the same pose and settings"},
    ),
    "bass_fit_reference_band_unavailable": ReasonSpec(
        ...
        next_action={"id": "measure_bass_reference", "label": "Measure a sweep that covers the reference band"},
    ),
    "bass_fit_requires_room_baseline_and_exact_candidate": ReasonSpec(
        ...
        next_action={"id": "select_bass_pair", "label": "Select the room baseline and the measured bass candidate"},
    ),
    "bass_fit_inputs_missing": ReasonSpec(
        "bass_fit_inputs_missing", TEMPLATE_HARD_STOP, 0, "", "No bass pairs are available for this fit.",
        next_action={"id": "select_bass_run", "label": "Select a run with baseline and candidate takes"},
    ),
    "bass_fit_pose_missing": ReasonSpec(
        "bass_fit_pose_missing", TEMPLATE_HARD_STOP, 0, "", "The bass capture has no recorded pose.",
        next_action={"id": "measure_bass_pose", "label": "Measure with a recorded microphone pose"},
    ),
    "bass_target_invalid": ReasonSpec(
        "bass_target_invalid", TEMPLATE_HARD_STOP, 0, "", "The bass target curve is invalid.",
        next_action={"id": "correct_bass_target", "label": "Supply an ordered target curve from 20 to 200 Hz"},
    ),
    "bass_table_tolerance_invalid": ReasonSpec(
        ...
        next_action={"id": "correct_bass_tolerance", "label": "Supply a positive tolerance in dB"},
    ),
    "bass_table_operating_level_missing": ReasonSpec(
        ...
        next_action={"id": "measure_bass_level", "label": "Record Main, Aux1 and program identity on each take"},
    ),
    "bass_table_capture_integrity_failed": ReasonSpec(
        ...
        next_action={"id": "repeat_bass_capture", "label": "Repeat the failed capture"},
    ),
    "bass_table_capture_context_changed": ReasonSpec(
        ...
        next_action={"id": "match_bass_levels", "label": "Measure all levels with the same stimulus and setup"},
    ),
    "bass_fit_pairs_unavailable": ReasonSpec(
        ...
        next_action={"id": "complete_bass_pairs", "label": "Measure baseline and candidates at matching levels and poses"},
    ),
    "bass_fit_candidate_unreadable": ReasonSpec(
        ...
        next_action={"id": "select_bass_candidate", "label": "Supply the candidate artifact named by the run"},
    ),
    "bass_fit_run_mismatch": ReasonSpec(
        "bass_fit_run_mismatch", TEMPLATE_HARD_STOP, 0, "", "The selected run does not match this manifest.",
        next_action={"id": "select_bass_run", "label": "Select the run recorded in this manifest"},
    ),
