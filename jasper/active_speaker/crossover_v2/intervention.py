...
def compose_linearized_prediction(
    ...
    *,
    ...
    THE composition: :func:`plan_linearization` composes from the FIT's
    filters, the per-driver prescription merge recomposes from the filters that
    will actually ship, and a second implementation of this arithmetic is how a
...
class LinearizationPlan:
    ...
    moves this candidate's anchor and cannot.
    """
