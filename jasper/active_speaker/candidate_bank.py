...
Integrity belongs to ``MeasuredCrossoverCandidate.from_mapping``; this module
only adds bounds and identity resolution. It must NOT move under
``crossover_v2/``: importing that package pulls numpy, and its import-light
consumers never agreed to that cost.
"""
