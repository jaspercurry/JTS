...
# A step this speaker's shape will never run — the same spelling the /correction/
# journey's closed step vocabulary uses for a passive topology
# (docs/correction-journey-design.md §5).
