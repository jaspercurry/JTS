...
# --- channel-routed program graph (crossover measurement session) ------------
# The v2 crossover flow plays ONE continuous 2-channel program WAV
# (docs/crossover-measurement-productization-design.md §5.4): capture ch0
# carries the woofer stimulus, ch1 the tweeter stimulus, sequenced in the WAV so
# the graph stays static. This graph maps each capture channel to its driver's
