    ...
    **The estimate contract.** The ask orders the answer: published value first,
    ...
    return "\n".join(
        (
            ...
            f"level_duration_limits: measurement-protocol discipline, not datasheet facts. Send max_sweep_duration_s at the role's protocol ceiling ({sweep_durations}; other roles {DEFAULT_DRIVER_SWEEP_DURATION_S:g} s) unless a datasheet says stricter.",
            ...
            *_driver_research_prompt_limits(request),
            ...
            f'    "level_duration_limits": {{"max_sweep_duration_s":{example_duration:g}}},',
