...
def supported_declaration_filter_types() -> tuple[str, ...]:
    ...
    that arrives here and is refused. The blocker below that does the refusing
    (``crossover_preview_filter_unsupported``) used to be the first place
    anyone heard about it, several screens after the field was filled in.
