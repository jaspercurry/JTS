...
# --------------------------------------------------------------------------- #
# the status projection — what ``status["crossover_v2"]`` carries
# --------------------------------------------------------------------------- #
#
# The read side of the durable v2 state, and the input every builder above
# consumes. Pure: it decides nothing, writes nothing and touches no file.
# :mod:`jasper.web.correction_crossover_v2_status` is the adapter that loads
# the state, supplies the few answers only the web host holds, and shapes what
# comes back into the page's dict.
