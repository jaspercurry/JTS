...
An advisory record (the Fc sweep's ``FcSelection``, and whatever supersedes it)
stays what it is — evidence the review screen renders — and stops being a gate
it was never able to keep honest.
