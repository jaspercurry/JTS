...
Owns :class:`CrossoverV2Session`: session state, the injected side-effect seams
(:class:`V2FlowSeams`), the locks, and the irreversible acts. Every verdict,
policy, fit and grade lives in :mod:`jasper.active_speaker.crossover_v2`; this
module imports that package and the package never imports this module or the
web host. Nothing is applied inside a session — the household POSTs the apply.
"""
