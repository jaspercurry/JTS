...
# 2753-second systemd bound covers all four sources, bounded owner barriers,
# failed-unit resets, and fail-closed cleanup; its caller allows 2763 seconds for
...
_SOURCE_INTENT_EXEC_TIMEOUT_CEILING_SEC = 2763.0
    ...
    *units: str,
    ...
    try:
        with socket.socket(socket.AF_UNIX, socket.SOCK_STREAM) as sock:
            ...
            # it: 2763 s + a 5 s margin, doubled, is 5536 s against nginx's
