...
# = target_level = 128) the derived solo offset is ~-0.0212 s
# (512 + 128 + 128 + a live outputd DAC delay of ~248 frames, all / 48000).
# 0.165 is a documented round-number estimate, deliberately NOT that
...
# DEFAULT_RING_A_LATENCY_FRAMES=512, DEFAULT_RING_B_LATENCY_FRAMES=128,
...
# target_level=4096): (512 + 4096 + 128 + 3072) / 48000 = 0.162667 s. 0.165
...
PIPELINE_FIXED_DELAY_SEC = 0.165
