...
# names registered in the sound module's _JTS_GENERATED_RE — so a /sound
# apply while bonded recognises them as JTS-generated, preserves
...
def restore_action(
    *, stash: str | None, stash_usable: bool, bonded_active: bool,
    ...
    load-bearing: a /sound save WHILE BONDED regenerates
...
def active_leader_pipe_path() -> str:
    ...
    # and the ``config_path`` parse live in active_speaker.environment, over
    # the default jasper.paths names. Lazy like every other import in this module,
