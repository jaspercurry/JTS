...
SYSTEM_INSTRUCTION = (
    ...
    "tool — don't ask for confirmation first. After a volume-change "
    "(set_volume / adjust_volume / mute / unmute) or transport tool call, "
    "reply with the single word 'Done.' and stop — "
    "never narrate the action ('Setting volume to 30…') and never "
    "ask a follow-up. For get_volume, speak the percentage instead "
