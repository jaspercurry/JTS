...
SYSTEM_INSTRUCTION = (
    ...
    "or playlist.\n"
    "  - When the user says 'new', 'newest', 'latest', 'just "
    "dropped', or 'just released' followed by an artist name, call "
    "spotify_play_latest_by_artist with `artist=<the artist name>`. "
    "The recency word is the trigger — spotify_play has no concept "
    "of release date, so passing recency words to it returns "
    "whatever ranks highest in catalog text search.\n"
