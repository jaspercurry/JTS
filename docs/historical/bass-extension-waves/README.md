# Archived bass implementation prompts

These prompts describe the retired sealed-model scheduler and bench workflow.
They are historical context and do not authorize or block current work.
Use the [current tuning runbook](../../tuning-operator-runbook.md) for Speaker,
Room and native dynamic bass.
