# DLNA/UPnP media input — design record (2026-05)

> **An unbuilt design, archived.** Nothing here exists in the codebase: there
> is no `jasper/dlna/`, no `gmediarender.service`, and no DLNA fan-in lane. The
> operational summary — scope, non-goals, the integration shape, and what would
> gate a build — is [HANDOFF-dlna.md](../HANDOFF-dlna.md); the choice of DLNA
> over Google Cast is
> [ADR-0119](../adr/0119-dlna-is-the-phone-casting-surface.md). This file keeps
> the renderer research, the component-level plan, the systemd and install.sh
> shape, the RAM budget, the sidecar sketch, the decision records, and the
> upmpdcli evaluation.
>
> **Before implementing any of it**, re-read
> [audio-paths.md](../audio-paths.md) "Adding a new music source" and
> [HANDOFF-fan-in-daemon.md](../HANDOFF-fan-in-daemon.md) — those are the
> operational source of truth for the topology, and this document is written
> against the topology as it stood in 2026-05.

## Why DLNA, not Google Cast — the 2026-05 survey
...
Archived 2026-08-26 from `docs/HANDOFF-dlna.md`. Package versions, upstream
issue states, LoC estimates, and topology references are as-written in
2026-05 (with a 2026-08-15 correction to the substream allocation).
