# Management UI redesign — proposal and research (2026-05)

> **Archived proposal, not current guidance.** The operational reference — the
> canonical design system, the restyle-in-place rules, the archetype recipes,
> the typographic grammar, the surface inventory, and the anti-patterns — is
> [HANDOFF-management-ui.md](../HANDOFF-management-ui.md). The one-frontend
> decision this proposal's shape rests on is
> [ADR-0120](../adr/0120-one-management-frontend-gated-by-capability.md).
>
> This file keeps the 2026-05 proposal itself: why the redesign was needed, the
> pre-Phase-1 inventory that motivated it, the three proposals (information
> architecture, setup wizard, copy), the phased rollout, the open decisions as
> they stood, the competitor and design research behind every call, and the
> pre-flight checklist. **Products evolve** — re-verify anything here before
> reasoning from it, especially the competitor snapshots.
...
## The pre-Phase-1 inventory (2026-05-28)
...
Archived 2026-08-26 from `docs/HANDOFF-management-ui.md`. Competitor
snapshots, phase states, and inventory counts are as-written in 2026-05.
