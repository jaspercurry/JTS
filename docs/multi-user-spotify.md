...
| Volume / mute | Source-aware via `VolumeCoordinator`: AirPlay uses CamillaDSP as the speaker volume; Spotify Connect uses Spotify Web API; Bluetooth uses AVRCP. | Same |
