...
- **Hardware bring-up**: Pi 5 (1 GB) + moOde 10.1.2 + always-on CamillaDSP + Apple USB-C dongle as DAC + ReSpeaker XVF3800 as mic. AirPlay/MPD/Spotify Connect all flow through CamillaDSP to the dongle. See `BRINGUP.md`.
