...
How this saved record selects the runtime graph — including the unconfigured
parked fallback — is owned by the [speaker-output reference](HANDOFF-speaker-output-reference.md#current-outputd-state).
