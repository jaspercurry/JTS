...
| [0334](0335-dynamic-bass-reduction-is-common-across-the-cardioid-pair.md) | Dynamic-bass reduction is common across a cardioid pair: one detector on the front lane, one gain on both lanes | accepted |
