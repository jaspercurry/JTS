...
session, never a graph that is already playing. The apply transaction restores
the exact predecessor graph, following the adoption table on a measured delta (§3);
