...
The restriction is unchanged; what changed is that it is now **enforced in code
rather than only written here**, and that the mechanism turned out to be two
different defects rather than one:
