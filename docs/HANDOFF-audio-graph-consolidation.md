...
| **U3 — renderer ring ingress** | P6a–d, one lane at a time, **AirPlay LAST** with offset re-derivation. **Three of four lanes are on rings as of 2026-08-13** — librespot (P6a [#2389](https://github.com/jaspercurry/JTS/pull/2389)), bluealsa (P6b [#2393](https://github.com/jaspercurry/JTS/pull/2393)), correction (P6c, five PRs — see the P-row) — all default-empty; **P6d shairport remains** | P6 | per-lane source pass (all OWED — no box armed); AirPlay adds a Music.app local-track loop + resync-log watch + bonded A/V spot-check |
