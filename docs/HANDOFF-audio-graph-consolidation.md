...
| R7a | DAC8x `LatencyFloor` + floor soak | design converged (v2 + ratified errata) — floor PR drafts after the Stage A/B soak passes; gated on the soak verdict |
