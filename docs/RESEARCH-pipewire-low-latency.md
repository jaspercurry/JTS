...
**Status (updated 2026-08-02):** increments 1–3 have landed (#1067 the
`jasper-clock` crate; #1069 the DAC-clock observer and the ad-hoc-loop
converge onto the shared `Dll`). Increment 5's unused
