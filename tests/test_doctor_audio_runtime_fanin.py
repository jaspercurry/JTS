...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(_fanin_case_status_socket_unreachable, "fail", _F.REASON_FANIN_STATUS_UNREACHABLE, None, id="test_check_fanin_service_fails_when_status_socket_unreachable"),
