...
def test_overlong_capture_is_bounded_before_analysis(tmp_path, monkeypatch):
    ...
    so it can't drive the FFT to OOM,
...
#
# analyze_driver_capture optionally accepts noise_band_report and computes
# jasper.audio_measurement.snr_policy.band_snr_verdicts. These tests
...
# populates a real verdict block.
