...
@pytest.mark.parametrize("raw", [
    ...
    "Mon, 1 Jan 2020 00:00:00 +99999999999999999999",
    "Mon, 1 Jan 99999999999999999999 00:00:00 +0000",
])
def test_date_fields_are_empty_for_a_date_past_the_calendar(raw):
    assert gmail_mod._date_fields(raw) == {}
