...
def test_capture_page_version_contract_is_published_and_cache_busted():
    ...
    assert "main.js?v=20260828-2" in index_html
    main_js = (_REPO / "capture-page/js/main.js").read_text(encoding="utf-8")
    ...
    assert 'from "./capture-protocol.js?v=20260828-2"' in main_js
...
_CAPTURE_PAGE_JS_DIGEST = (
    "bd0bd9d3141cc4182d3d06950e3714f4b9baffa1cc8436271229abad4a5e2534"
)
_CAPTURE_PAGE_JS_DIGEST_BUILD = "20260828.2"
